	  ...
	  $('#contact-form').on('submit', e => {
	    ...
	    if (email === "" || !/^[^@]+@[^@]+\.[^@]+$/.test(email)) {
	      createElement($, 'p', {
	        ...
	        id: 'validation-text'
	      }, "Incorrect email", '#validation-container');
	      createElement($, 'i', {
	        class: "bi bi-exclamation-circle ps-2"
	      }, "", "#validation-text");
	    } else {
	      createElement($, 'p', {
	        class: 'my-11 lh-sm text-success d-flex align-items-center',
	        id: 'validation-text'
	      }, "Success", '#validation-container');
	      createElement($, 'i', {
	        class: "bi bi-check-circle ps-2"
	      }, "", "#validation-text");
	...
	function categoryDropdown($) {
	  ...
	  dropdownButtonSidebarVariant.on('click', function () {
	    ...
	    if (dropdownMenuSidebarVariant.hasClass('show-menu')) {
	      ...
	      dropdownMenuSidebarVariant.slideUp(300, function () {
	        dropdownSidebarVariant.css('background-color', "");
	      });
	  ...
	  dropdownButtonHeaderVariant.on('click', function () {
	    ...
	    if (dropdownMenuHeaderVariant.hasClass('show-menu')) {
	      ...
	      dropdownMenuHeaderVariant.slideUp(300, function () {
	        dropdownHeaderVariant.css('background-color', "");
	      });
