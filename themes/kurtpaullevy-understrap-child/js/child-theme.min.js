...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(t){t.exports=function(t,e,n,i){const s="toast",o=".bs.toast",r=`mouseover${o}`,a=`mouseout${o}`,l=`focusin${o}`,c=`focusout${o}`,u=`hide${o}`,d=`hidden${o}`,h=`show${o}`,f=`shown${o}`,p="fade",g="hide",m="show",_="showing",b={animation:"boolean",autohide:"boolean",delay:"number"},v={animation:!0,autohide:!0,delay:5e3};class y extends t{constructor(t,e){super(t,e),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get Default(){return v}static get DefaultType(){return b}static get NAME(){return s}show(){if(e.trigger(this._element,h).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(p);const t=()=>{this._element.classList.remove(_),e.trigger(this._element,f),this._maybeScheduleHide()};this._element.classList.remove(g),i.reflow(this._element),this._element.classList.add(m,_),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this.isShown())return;if(e.trigger(this._element,u).defaultPrevented)return;const t=()=>{this._element.classList.add(g),this._element.classList.remove(_,m),e.trigger(this._element,d)};this._element.classList.add(_),this._queueCallback(t,this._element,this._config.animation)}dispose(){this._clearTimeout(),this.isShown()&&this._element.classList.remove(m),super.dispose()}isShown(){return this._element.classList.contains(m)}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(t,e){switch(t.type){case"mouseover":case"mouseout":this._hasMouseInteraction=e;break;case"focusin":case"focusout":this._hasKeyboardInteraction=e}if(e)return void this._clearTimeout();const n=t.relatedTarget;this._element===n||this._element.contains(n)||this._maybeScheduleHide()}_setListeners(){e.on(this._element,r,(t=>this._onInteraction(t,!0))),e.on(this._element,a,(t=>this._onInteraction(t,!1))),e.on(this._element,l,(t=>this._onInteraction(t,!0))),e.on(this._element,c,(t=>this._onInteraction(t,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(t){return this.each((function(){const e=y.getOrCreateInstance(this,t);if("string"==typeof t){if(void 0===e[t])throw new TypeError(`No method named "${t}"`);e[t](this)}}))}}return n.enableDismissTrigger(y),i.defineJQueryPlugin(y),y}(C(),m(),P(),g())}({get exports(){return cn},set exports(t){cn=t}});var un,dn,hn,fn,pn=cn;function gn(t,e,n={},i="",s="body"){const o=t("<"+e+">");return Object.entries(n).forEach((([t,e])=>{o.attr(t,e)})),o.html(i),t(s).append(o),o}function mn(t){t("#contact-form").on("submit",(e=>{e.preventDefault();const n=t("#email").val();t("#validation-container").text(""),""!==n&&(/^[^@]+@[^@]+\.[^@]+$/.test(n)?(gn(t,"p",{class:"my-11 lh-sm text-success d-flex align-items-center",id:"validation-text"},"Success","#validation-container"),gn(t,"i",{class:"bi bi-check-circle ps-2"},"","#validation-text"),function(t,e){const n=`${window.location.origin}/wp-admin/admin-ajax.php`;t.ajax({type:"post",url:n,data:{action:"register_user",ajax_data:e}})}(t,n)):(gn(t,"p",{class:"my-11 lh-sm text-warning d-flex align-items-center",id:"validation-text"},"Incorrect email","#validation-container"),gn(t,"i",{class:"bi bi-exclamation-circle ps-2"},"","#validation-text")))}))}function _n(t,e){return new IntersectionObserver((function(e,n){e.forEach((function(e){if(e.isIntersecting){const i=t(e.target);i.hasClass("fade-init")&&i.removeClass("fade-init").addClass("fade-in"),n.unobserve(e.target)}}))}),{threshold:e})}function bn(t,e){t&&0!==t.length&&setTimeout((()=>{t.each((function(){e.observe(this)}))}),500)}function vn(t){const e=t("article.format-image"),n=t("body").hasClass("home")?t("#wrapper-footer"):t();o(e);let i=_n(t,.2);bn(e,i);let s=function(t,e){return new IntersectionObserver((function(e,n){e.forEach((function(e){e.isIntersecting&&(t(e.target).find(".footer-intro-text").addClass("fade-in"),n.unobserve(e.target))}))}),{threshold:e})}(t,.3);function o(e){e.each((function(){this.getBoundingClientRect().top>window.innerHeight&&t(this).addClass("fade-init")}))}bn(n,s),t(document).on("newContentLoaded",(function(){i.disconnect();const e=t("article.format-image");o(e),i=_n(t,.2),bn(e,i)}))}function yn(t,e){!function(t,{category:e="All work"}){const n=`${window.location.origin}/wp-admin/admin-ajax.php`;t.ajax({url:n,method:"POST",data:{action:"filter_category_posts",category:e},success:function(e){if(e.success){const n=t("#image-grid-container");n.fadeOut(500,(function(){window.scrollTo({top:0,behavior:"instant"}),n.html(e.data),n.fadeIn(500),t(document).trigger("newContentLoaded")}))}else console.log("Error: "+e.data.error)}})}(t,{category:e})}function wn(t){const e=t(".category-dropdown__menu-btn"),n=t(".category-dropdown-menu"),i=t(".scroll-container"),s=t(".category-dropdown");function o(){s.find(".icon-caret-down").toggleClass("rotated"),n.hasClass("open")?(n.removeClass("open"),setTimeout((()=>{s.css("background-color","")}),300),e.attr("aria-expanded","false")):(n.addClass("open"),s.css("background-color","#EFEFEF"),e.attr("aria-expanded","true"),setTimeout((()=>{const t=SimpleBar.instances.get(i[0]);t&&(t.recalculate(),t.getScrollElement().scrollTop=0)}),50),function(){function e(n){t(n.target).closest(".category-dropdown").length||(o(),t(document).off("click.dropdown",e))}t(document).off("click.dropdown"),t(document).on("click.dropdown",e)}())}t("body").on("click",".category-dropdown__menu-btn",(function(){o()})),t("body").on("click",".category-dropdown-menu .menu-item",(function(e){e.preventDefault(),t(document).off("click.dropdown");const n=t(this);t(".category-dropdown-menu .menu-item").removeClass("hidden").addClass("visible"),n.addClass("hidden").removeClass("visible");const i=n.text();t("#dropdown-btn-text").text(i),o(),yn(t,i)}))}function xn(t){const e=t(".gallery-lightbox"),n=t(".gallery-lightbox__track"),i=t("#image-grid-container"),s=t(".gallery-lightbox__btn--prev"),o=t(".gallery-lightbox__btn--next"),r=t(".gallery-lightbox__btn--close");let a,l;function c(){const t=window.visualViewport?window.visualViewport.height:window.innerHeight;e.css("height",t+"px")}function u(){const e=(window.visualViewport?window.visualViewport.height:window.innerHeight)-parseFloat(getComputedStyle(t(".gallery-lightbox__content")[0]).paddingTop)-parseFloat(getComputedStyle(t(".gallery-lightbox__content")[0]).paddingBottom)-112;t(".gallery-lightbox__item").each((function(){t(this).css("height",e+"px")}))}function d(){n.css("transform","translateX("+-100*l+"%)"),a.each((function(e,n){e===l?t(n).attr("aria-hidden","false"):t(n).attr("aria-hidden","true")}))}i.on("click",(function(i){const s=t(i.target).closest(".format-image");s.length&&(l=s.index()+1,function(){a=t("#image-grid-container article");const e=[];a.each((function(){const n=t(this),i=n.find("img").attr("src"),s=n.find("img").attr("alt")||"",o=n.find("img").attr("srcset"),r=n.find("img").attr("fetchPriority"),a=n.find("p").first().html().split("<br>").map((t=>t.trim())),l=a[0]||"",c=a[1]||"",u=a[2]||"",d=n.find(".category-pill-container .category-pill");let h="";d.each((function(){const e=t(this).text().trim();h+=`<div class="tag">${e}</div>`}));const f=`\n            <div class="gallery-lightbox__item">\n              <img src="${i}" alt="${s}" srcset="${o}" fetchPriority="${r}" />\n              <div class="gallery-lightbox__info">\n                <div class="gallery-lightbox__meta">\n                  <p>${l} <br> ${c} <br> ${u}</p>\n                </div>\n                <div class="gallery-lightbox__tags">\n                  ${h}\n                </div>\n              </div>\n            </div>\n          `;e.push(f)})),n.html(e.join("")),a=n.children(),function(){let t=a.eq(0).clone();n.append(t),t.attr("id","firstClone");let e=a.eq(a.length-1).clone();e.attr("id","lastClone"),n.prepend(e),a=n.children()}()}(),d(),c(),u(),t("body").addClass("lightbox-open"),e.addClass("lightbox-gallery--open"),e.attr("aria-hidden","false"),e.focus())})),s.on("click",(function(){n.css("transition","transform 0.4s ease-in-out"),l<=0||(l--,d())})),o.on("click",(function(){n.css("transition","transform 0.4s ease-in-out"),l>=a.length-1||(l++,d())})),n.on("transitionend",(function(){"lastClone"===t(a[l]).attr("id")&&(n.css("transition","none"),l=a.length-2,d()),"firstClone"===t(a[l]).attr("id")&&(n.css("transition","none"),l=1,d())})),r.on("click",(function(){n.css("transition","none"),t("body").removeClass("lightbox-open"),e.removeClass("lightbox-gallery--open"),e.attr("aria-hidden","true"),t("#image-grid-container").html(undefined),t(this).focus()})),t(window).on("resize orientationchange",(function(){e.hasClass("lightbox-gallery--open")&&(c(),u())})),"visualViewport"in window&&window.visualViewport.addEventListener("resize",(()=>{e.hasClass("lightbox-gallery--open")&&(c(),u())})),t(document).on("keydown",(function(t){"ArrowLeft"===t.key?s.click():"ArrowRight"===t.key?o.click():"Escape"===t.key&&r.click()}))}un=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,dn=navigator.userAgent.toLowerCase().indexOf("opera")>-1,hn=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(un||dn||hn)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var t,e=location.hash.substring(1);/^[A-z0-9_-]+$/.test(e)&&(t=document.getElementById(e))&&(/^(?:a|select|input|button|textarea)$/i.test(t.tagName)||(t.tabIndex=-1),t.focus())}),!1),(fn=jQuery)(document).ready((function(){!function(t){let e=!1;function n(){t(".content-area, #sidebar__contact, .category-dropdown, #scroll-progress-bar, body.home #wrapper-footer").removeClass("loaded")}t("body").hasClass("archive")?(t("#sidebar__contact, .category-dropdown, #scroll-progress-bar, body.home #wrapper-footer").addClass("loaded"),t(".content-area").addClass("loaded")):t(".content-area, #sidebar__contact, .nav-category-menu, .category-dropdown, #scroll-progress-bar, body.home #wrapper-footer").addClass("loaded"),t("#menu-sidebar-menu a, #main-menu a, .custom-logo-link").on("click",(function(t){if(!e){e=!0;var i=this;t.preventDefault(),n(),setTimeout((function(){window.history.pushState({path:i.href},"",i.href),window.location=i.href}),500)}})),t(window).on("popstate",(function(){n(),setTimeout((function(){location.reload()}),500)}))}(fn),vn(fn),function(t){const e=t("#scroll-progress-bar");t(window).on("scroll",(function(){const t=window.scrollY/(document.documentElement.scrollHeight-window.innerHeight)*100;e.width(t+"%")}))}(fn),function(t){if(t("body").hasClass("home"))return;const e=t("#main-nav");if(0===e.length)return;let n=window.scrollY,i=0;const s=e.outerHeight();let o;t(window).on("scroll",(function(){clearTimeout(o),o=setTimeout((function(){let t=window.scrollY;t<=0?i=0:(i+=t-n,i=Math.max(0,Math.min(s,i))),e.css("transform",`translateY(-${i}px)`),n=t}),11)}))}(fn),mn(fn),wn(fn),function(t){t("body").on("click",".nav-category-menu .menu-item",(function(e){e.preventDefault();const n=t(this).text();yn(t,n)})),t(".nav-category-menu").on("click",".btn-navbar-category",(function(){t(".nav-category-menu .btn-navbar-category").removeClass("active").attr("aria-pressed","false"),t(this).addClass("active").attr("aria-pressed","true")}))}(fn),xn(fn),function(t){const e=t(".back-to-top"),n=t(".site-footer");function i(){const i=t(window).scrollTop(),s=t(window).height();e.outerHeight();const o=n.length?n.offset().top:0,r=i+s;if(i>.25*s?e.addClass("back-to-top--visible"):(e.removeClass("back-to-top--no-transition"),e.removeClass("back-to-top--visible")),r>=o){const t=r-o+65;e.addClass("back-to-top--no-transition").css("bottom",`${t}px`)}else e.hasClass("back-to-top--visible")&&e.css("bottom","")}e.length&&(e.on("click",(function(e){e.preventDefault(),t("html, body").animate({scrollTop:0},600)})),i(),t(window).on("scroll resize",i))}(fn),function(t){t(window).on("load",(function(){t("body").addClass("page-loaded")}))}(fn)})),t.Alert=I,t.Button=M,t.Carousel=W,t.Collapse=q,t.Dropdown=ke,t.Modal=ze,t.Offcanvas=qe,t.Popover=sn,t.Scrollspy=rn,t.Tab=ln,t.Toast=pn,t.Tooltip=nn}));
